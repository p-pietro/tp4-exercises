...
VectorXcd integrate(const MatrixXcd &H, const VectorXcd &psi0, double t_span, double t_eval, bool use_ode = true);
...
vector<VectorXcd> montecarlo(const MatrixXcd &H, const vector<MatrixXcd> &c_ops, const VectorXcd &psi0, const vector<double> &tlist, unsigned int seed = 0, bool use_ode = true);
